...
public class DirectoryUtil {
    ...
    private DirectoryUtil() {
        ...
        APP_CACHE = SYSTEM_APP_EXTERNAL_CACHE; // /storage/emulated/0/Android/data/com.mjiayou.tcdemo/cache/
        APP_CACHE_IMAGE = APP_CACHE + "image/"; // /storage/emulated/0/Android/data/com.mjiayou.tcdemo/cache/image/
        APP_CACHE_DATA = APP_CACHE + "data/"; // /storage/emulated/0/Android/data/com.mjiayou.tcdemo/cache/data/
    }
