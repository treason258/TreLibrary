...
//        float value = 100f;
//        builder.append("\n");
//        builder.append("基数 = ").append(value).append("\n");
//        builder.append("dp2px = ").append(dp2px(context, value)).append("\n");
//        builder.append("dp2pxOld = ").append(dp2pxOld(context, value)).append("\n");
//        builder.append("px2dp = ").append(px2dp(context, value)).append("\n");
//        builder.append("sp2px = ").append(sp2px(context, value)).append("\n");
//        builder.append("px2sp = ").append(px2sp(context, value)).append("\n");
...
//     */
//    @Deprecated
//    public static int dp2pxOld(Context context, float dpValue) {
