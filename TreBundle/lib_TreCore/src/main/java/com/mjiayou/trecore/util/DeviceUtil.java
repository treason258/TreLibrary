...
//        builder.append("手机存储的总空间大小 = ").append(getInternalTotalMemorySize() / (1024 * 1024) / 1024).append("G").append("\n");
//        builder.append("手机存储的可用空间大小 = ").append(getInternalAvailableMemorySize() / (1024 * 1024) / 1024).append("G").append("\n");
//        builder.append("是否存在SD卡 = ").append(existExternalCard()).append("\n");
//        builder.append("SD卡存储的总空间大小 = ").append(getExternalTotalMemorySize() / (1024 * 1024) / 1024).append("G").append("\n");
//        builder.append("SD卡存储的可用空间大小 = ").append(getExternalAvailableMemorySize() / (1024 * 1024) / 1024).append("G").append("\n");
//
//        // other
//        builder.append("\n");
...
//        builder.append(ConvertUtil.parseString(Build.class));
//
//        builder.append("** Build.VERSION.class **").append("\n");
//        builder.append(ConvertUtil.parseString(Build.VERSION.class));
//
//        builder.append("** Build.VERSION_CODES.class **").append("\n");
//        builder.append(ConvertUtil.parseString(Build.VERSION_CODES.class));
//
//        return builder.toString();
//    }
//
