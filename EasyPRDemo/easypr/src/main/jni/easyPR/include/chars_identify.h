...
namespace easypr {
    ...
    public:
        ...
        /////////////////  add by liangmin /////////////////////
        static CharsIdentify* instance(std::string ann_path, std::string ann_chinese_path, std::string etc_path);
        ////////////////////////////////////////////////////////
        
        
        static CharsIdentify* getInstance();
        void releaseModel();
    ...
    private:
        ...
        /////////////////  add by liangmin /////////////////////
        CharsIdentify(std::string ann_path, std::string ann_chinese_path, std::string etc_path);
        ///////////////////////////////////////////////////////
