...
static const char* kDefaultSvmPath = "../model/svm.xml";
static const char* kLBPSvmPath = "../model/svm_lbp_final.xml";
static const char* kDefaultAnnPath = "../model/ann.xml";
static const char* kChineseAnnPath = "../model/ann_chinese.xml";
static const char* kEtcProvince = "../etc/province_mapping";
