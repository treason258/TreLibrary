...
#include "easyPR/include/plate_locate.h"
#include "easyPR/include/plate_judge.h"
#include "easyPR/include/chars_segment.h"
#include "easyPR/include/chars_identify.h"
#include "easyPR/include/plate_detect.h"
#include "easyPR/include/chars_recognise.h"
#include "easyPR/include/plate_recognize.h"
#include "easyPR/include/api.hpp"
...
JNIEXPORT jlong JNICALL Java_com_aiseminar_EasyPR_PlateRecognizer_initPR(JNIEnv *env, jclass instance, jstring svmpath ) {
...
JNIEXPORT jfloatArray JNICALL Java_com_aiseminar_EasyPR_PlateRecognizer_platePosition(JNIEnv *env, jclass instance,  jstring imgpath) {
  //  CPlateRecognize *pr = (CPlateRecognize *)recognizerPtr;
 ...
 //	strcpy(result, str.c_str());
	...
	jfloatArray jarray = env->NewFloatArray(8);
	 //env->SetByteArrayRegion(jarray, 0, strlen(result), by);
   vector<Point2f> plateVec;
            int result = api::plate_detect(src,plateVec,1,0);
            if (result > 0)  {
                    ...
                    data[6]=plateVec[3].x;
                    data[7]=plateVec[3].y;
                    env->SetFloatArrayRegion( jarray, 0, 8, data);
            }
	return jarray;
}
