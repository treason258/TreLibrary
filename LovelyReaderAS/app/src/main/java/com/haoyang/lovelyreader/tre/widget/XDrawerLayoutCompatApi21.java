...
public class XDrawerLayoutCompatApi21 {
    ...
    public static void configureApplyInsets(View drawerLayout) {
        if (drawerLayout instanceof XDrawerLayoutImpl) {
            drawerLayout.setOnApplyWindowInsetsListener(new XDrawerLayoutCompatApi21.InsetsListener());
    ...
    static class InsetsListener implements View.OnApplyWindowInsetsListener {
        ...
        public WindowInsets onApplyWindowInsets(View v, WindowInsets insets) {
            final XDrawerLayoutImpl drawerLayout = (XDrawerLayoutImpl) v;
