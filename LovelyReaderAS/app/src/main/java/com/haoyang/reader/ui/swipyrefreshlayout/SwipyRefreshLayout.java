...
package com.haoyang.reader.ui.swipyrefreshlayout;
...
public class SwipyRefreshLayout extends ViewGroup {
    ...
    public SwipyRefreshLayout(Context context, AttributeSet attrs) {
        ...
        // AndroidAppService androidAppService = new AndroidAppService(context);
        
        //int swipyRefreshLayoutId = androidAppService.getStyleableResource("SwipyRefreshLayout");
        
//        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.SwipyRefreshLayout);
//        final TypedArray a2 = context.obtainStyledAttributes(attrs, R.styleable.SwipyRefreshLayout);
        SwipyRefreshLayoutDirection direction = SwipyRefreshLayoutDirection.BOTH; 
